...
function useDataFormInfo(): [Maybe<DataFormInfo>, boolean] {
    ...
    const SourceTypeApplyToAll = useCallback<DataFormInfo["data"]["stApplyToAll"]>(
        async (dataValue: DataValueTextMultiple, sourceTypeDEs: DataElementRefType[]) => {
            if (!dataValues) return dataValues;
            return compositionRoot.dataForms.applyToAll(dataValues, dataValue, sourceTypeDEs).then(setDataValues);
        },
        [compositionRoot, dataValues]
    );
    ...
    const saveWithTotals = useCallback<DataFormInfo["data"]["saveWithTotals"]>(
        async (
            ...
            return compositionRoot.dataForms
                .saveWithTotals(dataValues, dataValue, total, columnTotal, rowDataElements, columnDataElements)
                .then(setDataValues);
        },
        [compositionRoot, dataValues]
    );
...
export interface DataFormInfo {
    ...
    data: {
        ...
        stApplyToAll: (dataValue: DataValueTextMultiple, sourceTypeDEs: DataElementRefType[]) => Promise<void>;
        saveWithTotals: (
            dataValue: DataValueNumberSingle,
            total: DataElement,
            columnTotal: DataElement,
