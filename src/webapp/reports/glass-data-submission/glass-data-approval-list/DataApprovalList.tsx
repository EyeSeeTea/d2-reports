...
export const DataApprovalList: React.FC = React.memo(() => {
    ...
    useEffect(() => {
        compositionRoot.malDataApproval.getColumns(Namespaces.DATA_SUBMISSSIONS_USER_COLUMNS).then(columns => {
    ...
    const saveReorderedColumns = useCallback(
        async (columnKeys: Array<keyof DataSubmissionViewModel>) => {
            ...
            await compositionRoot.malDataApproval.saveColumns(Namespaces.DATA_SUBMISSSIONS_USER_COLUMNS, columnKeys);
        },
